	...
	<ul class="list-group media-list media-list-stream">
				...
				<li class="media list-group-item p-a"><a class="media-left"
					...
					<div class="media-body">
						...
						<div class="media-body-inline-grid" data-grid="images">
							<div
								style="display: inline-block; margin-bottom: 10px; margin-right: 10px; vertical-align: bottom;">
								<img data-action="zoom" data-width="1050" data-height="700"
									src="assets/img/unsplash_1.jpg"
									style="width: 273px; height: 183px;">
							</div>
							<div
								style="display: inline-block; margin-bottom: 10px; margin-right: 0px; vertical-align: bottom;">
							...
							<div
								...
								<img data-action="zoom" data-width="1048" data-height="700"
									...
									style="width: 274px; height: 183px;">
							</div>
						</div>
						...
						<ul class="media-list m-b">
							<li class="media"><a class="media-left" href="#"> <img
								...
								<div class="media-body">
									<strong>Jacon Thornton: </strong> Donec id elit non mi porta
							...
							<li class="media"><a class="media-left" href="#"> <img
								...
								<div class="media-body">
									<strong>Mark Otto: </strong> Lorem ipsum dolor sit amet,
				...
				<li class="media list-group-item p-a"><a class="media-left"
					...
					<div class="media-body">
						...
						<div class="media-body-inline-grid" data-grid="images">
							<img
								style="display: inline-block; width: 467px; height: 452px; margin-bottom: 10px; margin-right: 0px; vertical-align: bottom;"
								data-width="640" data-height="640" data-action="zoom"
								src="assets/img/instagram_3.jpg">
						</div>

						<ul class="media-list">
							<li class="media"><a class="media-left" href="#"> <img
									class="media-object img-circle" src="assets/img/avatar-dhg.png">
							</a>
								<div class="media-body">
									<strong>Dave Gamache: </strong> Donec id elit non mi porta
									gravida at eget metus. Vivamus sagittis lacus vel augue laoreet
									rutrum faucibus dolor auctor. Donec ullamcorper nulla non metus
									auctor fringilla. Praesent commodo cursus magna, vel
									scelerisque nisl consectetur et. Sed posuere consectetur est at
